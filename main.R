...
data_g24ieee <- read.csv("data/IEEE/beta_G24_IEEE.csv", head=T, stringsAsFactors=F)
#data_g24ieee <- read.csv("data/IEEE/G24_IEEE_2021.10.07-21.09.18.csv", head=T, stringsAsFactors=F)
#data_g24ieee <- read.csv("data/IEEE/G24_IEEE_2021.10.08-09.03.01_SEM_5G.csv", head=T, stringsAsFactors=F)
